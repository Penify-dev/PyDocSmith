...
- **Detección de estilo de docstring:** Detecta automáticamente el estilo de las docstrings (por ejemplo, reST, Google, NumPydoc, Epydoc) usando heurísticas simples.
