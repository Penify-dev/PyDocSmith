...
3. A veces GoogleDoc string no tiene la indentación adecuada, especialmente cuando se genera desde LLM como GPT o Mistral. PyDocSmith puede corregir esas malas docstrings.
