...
- **Docstrings de atributos:** Analizar docstrings de atributos definidos en niveles de clase y módulo, mejorando la documentación de propiedades de clase y variables a nivel de módulo.
