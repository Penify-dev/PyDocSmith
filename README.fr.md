...
- **Composition des docstrings :** Rendre les docstrings structurées sous forme de texte, permettant la génération et la modification automatisées des docstrings.
- **Docstrings d'attributs :** Analyser les docstrings d'attributs définis aux niveaux de classe et de module, améliorant la documentation des propriétés de classe et des variables au niveau du module.
...
Rendre une docstring analysée sous forme de texte :
...
- **Analyse à partir d'un objet :** PyDocSmith peut analyser les docstrings directement à partir d'objets Python, y compris les classes et les modules, en incorporant les docstrings d'attributs dans la représentation structurée.
...
2. La docstring Google a été modifiée pour accueillir les Notes, les Exemples
...
J'ai mis à jour cela en fonction du cas d'utilisation pour - https://www.penify.dev
