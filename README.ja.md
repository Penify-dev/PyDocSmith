...
2. Google ドックストリングが Notes、Examples を収容するように変更されました
3. 時々 GoogleDoc 文字列は適切なインデントを持たない、特に LLMs のような GPT や Mistral から生成された場合。PyDocSmith はそれらの悪いドックストリングを修正できます。
4. GoogleDocstring の異なるスタイルを収容するための追加のテストケースが追加されました
