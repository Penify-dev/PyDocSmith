यह परियोजना मूल परियोजना की एक फोर्क है - https://github.com/rr-/docstring_parser/
...
- **डॉकस्ट्रिंग पार्सिंग:** डॉकस्ट्रिंग्स को संरचित प्रतिनिधित्व में परिवर्तित करें, जिससे दस्तावेजीकरण का विश्लेषण और हेरफेर करना आसान हो जाता है।
- **डॉकस्ट्रिंग रचना:** संरचित डॉकस्ट्रिंग्स को वापस टेक्स्ट में रेंडर करें, जिससे स्वचालित डॉकस्ट्रिंग जनरेशन और संशोधन की अनुमति मिलती है।
- **एट्रिब्यूट डॉकस्ट्रिंग्स:** क्लास और मॉड्यूल स्तर पर परिभाषित एट्रिब्यूट डॉकस्ट्रिंग्स को पार्स करें, क्लास प्रॉपर्टीज और मॉड्यूल-स्तरीय वेरिएबल्स के दस्तावेजीकरण को बढ़ाएं।
...
- **कस्टम रेंडरिंग शैलियाँ:** कॉम्पैक्ट या डिटेल्ड शैलियों के साथ डॉकस्ट्रिंग्स के रेंडरिंग को कस्टमाइज़ करें, और जनरेट की गई डॉकस्ट्रिंग टेक्स्ट के लिए कस्टम इंडेंटेशन निर्दिष्ट करें।
...
3. कभी-कभी GoogleDoc स्ट्रिंग में उचित इंडेंटेशन नहीं होता है, विशेष रूप से जब इसे LLMs जैसे GPT या Mistral से जनरेट किया जाता है। PyDocSmith उन खराब डॉकस्ट्रिंग्स को ठीक कर सकता है।
