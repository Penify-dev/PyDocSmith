...
- **Докстринги атрибутов:** Разбирать докстринги атрибутов, определенные на уровне классов и модулей, улучшая документацию свойств классов и переменных уровня модуля.
