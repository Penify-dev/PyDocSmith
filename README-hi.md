यह परियोजना मूल परियोजना का एक फोर्क है - https://github.com/rr-/docstring_parser/
...
- **Docstring शैली का पता लगाना:** सरल ह्यूरिस्टिक्स का उपयोग करके docstrings की शैली (जैसे, reST, Google, NumPydoc, Epydoc) को स्वचालित रूप से पता लगाएं।
- **Docstrings का पार्स करना:** Docstrings को संरचित प्रतिनिधित्व में परिवर्तित करें, जिससे दस्तावेज़ीकरण का विश्लेषण और हेरफेर करना आसान हो जाता है।
- **Docstrings का निर्माण:** संरचित docstrings को वापस टेक्स्ट में रेंडर करें, जिससे स्वचालित docstring निर्माण और संशोधन की अनुमति मिलती है।
