...
- **डॉकस्ट्रिंग पार्सिंग:** डॉकस्ट्रिंग को संरचित प्रतिनिधित्व में परिवर्तित करें, जिससे दस्तावेज़ीकरण का विश्लेषण और हेरफेर करना आसान हो जाए।
- **डॉकस्ट्रिंग रचना:** संरचित डॉकस्ट्रिंग को वापस टेक्स्ट में रेंडर करें, जिससे स्वचालित डॉकस्ट्रिंग निर्माण और संशोधन की अनुमति मिले।
- **विशेषता डॉकस्ट्रिंग:** कक्षा और मॉड्यूल स्तर पर परिभाषित विशेषता डॉकस्ट्रिंग को पार्स करें, कक्षा गुणों और मॉड्यूल-स्तरीय चर के दस्तावेज़ीकरण को बढ़ाएं।
...
- **ऑब्जेक्ट से पार्स करें:** PyDocSmith Python ऑब्जेक्ट से सीधे डॉकस्ट्रिंग पार्स कर सकता है, जिसमें कक्षाएं और मॉड्यूल शामिल हैं, विशेषता डॉकस्ट्रिंग को संरचित प्रतिनिधित्व में शामिल करते हुए।
- **कस्टम रेंडरिंग शैलियाँ:** कॉम्पैक्ट या विस्तृत शैलियों के साथ डॉकस्ट्रिंग के रेंडरिंग को कस्टमाइज़ करें, और उत्पन्न डॉकस्ट्रिंग टेक्स्ट के लिए कस्टम इंडेंटेशन निर्दिष्ट करें।
...
3. कभी-कभी GoogleDoc स्ट्रिंग में विशेष रूप से जब LLMs जैसे GPT या Mistral से उत्पन्न होती है तो उचित इंडेंटेशन नहीं होती। PyDocSmith उन खराब डॉकस्ट्रिंग को ठीक कर सकता है।
4. GoogleDocstring की विभिन्न शैली को समायोजित करने के लिए अतिरिक्त टेस्ट-केस जोड़े गए

मैंने इसे उपयोग के मामले के आधार पर अपडेट किया है - https://www.penify.dev

## योगदान

योगदान स्वागत योग्य हैं! कृपया परियोजना के GitHub पृष्ठ पर पुल अनुरोध सबमिट करें या मुद्दे रिपोर्ट करें।