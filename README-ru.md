...
3. Иногда GoogleDoc string не имеет правильного отступа, особенно когда генерируется из LLM вроде GPT или Mistral. PyDocSmith может исправить эти плохие докстринги.
4. Дополнительные тестовые случаи были добавлены для размещения другого стиля GoogleDocstring

Я обновил это на основе случая использования - https://www.penify.dev
