...
- **Пользовательские стили рендеринга:** Настраивать рендеринг докстрингов с компактными или детализированными стилями и указывать пользовательскую отступ для генерируемого текста докстринга.
