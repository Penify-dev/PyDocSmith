...
- **Docstrings атрибутов:** Анализирует docstrings атрибутов, определенных на уровне классов и модулей, улучшая документирование свойств классов и переменных уровня модуля.
...
Рендерит проанализированную docstring обратно в текст:
...
- **Пользовательские стили рендеринга:** Настраивайте рендеринг docstrings с компактными или детализированными стилями и указывайте пользовательскую отступ для сгенерированного текста docstring.
...
4. Дополнительные тестовые случаи были добавлены для размещения различного стиля GoogleDocstring
