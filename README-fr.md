...
- **Docstrings d'attributs :** Analyse les docstrings d'attributs définis au niveau des classes et des modules, améliorant la documentation des propriétés de classe et des variables au niveau du module.
...
- **Analyser depuis un objet :** PyDocSmith peut analyser les docstrings directement depuis des objets Python, y compris les classes et les modules, en incorporant les docstrings d'attributs dans la représentation structurée.
...
3. Parfois, la docstring Google n'a pas une indentation correcte, spécialement lorsqu'elle est générée par des LLMs comme GPT ou Mistral. PyDocSmith peut corriger ces mauvaises docstrings.
